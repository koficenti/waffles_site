...
export default function Home() {
  return (
    <main className="px-5 md:px-20 text-[#D3790D]">
      ...
      <div className="mt-10 md:mt-24 w-full md:flex justify-between place-items-center grid row-auto">
        <div id="left_content" className="md:w-[50%] text-center md:text-left md:text-left] row-start-2">
          ...
          <h3 className={`text-xl ${raleway.className} font-bold mt-20 mb-10`}>Subscribe to be notified when we launch! (June 2024)</h3>
      ...
      <div id="numbers" className="md:flex md:justify-between md:mt-24 py-5">
